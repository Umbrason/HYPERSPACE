...
public class SpaceshipInputHandler : MonoBehaviour, GameplayInput.ISpaceshipActions
{
    ...
    public static Action<Vector2> OnAimChanged;
    ...
    public static Action OnGodmodeToggled;
    ...
    {
        OnPrimaryFireChanged?.Invoke(context.ReadValueAsButton());
    }
    public void OnSecondaryFire(InputAction.CallbackContext context)
    {
        OnSecondaryFireChanged?.Invoke(context.ReadValueAsButton());
    }
    ...
    {
        if (context.performed) OnGodmodeToggled?.Invoke();
    }

    void GameplayInput.ISpaceshipActions.OnPause(InputAction.CallbackContext context)
    {
